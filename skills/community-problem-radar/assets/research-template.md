...
- User role and task:
- Requested window, with timezone:
- Observed window and selection method:
- Review effort or stopping rule:
- Evidence status: observed / user-reported / synthetic demonstration
...
- Raw total:
- Retained accounts after duplicate review:
- Removed copies:
- Duplicate rule and uncertain groups:
- Labels used; note that categories overlap:
